...
def stock_page(title, default_fee_beli, default_fee_jual):
    st.header(title)
    ...
    fee_beli = default_fee_beli if include_fee_beli else 0
    fee_jual = default_fee_jual if include_fee_jual else 0
